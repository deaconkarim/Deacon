...
// SVG content for the favicon (using the church icon from Logo component, now slightly smaller and centered)
const svgContent = `
...
// SVG content for larger icons (apple-touch-icon, etc., now slightly smaller and centered)
