...
// SVG content for the favicon (using the church icon from Logo component, now larger and centered)
const svgContent = `
...
// SVG content for larger icons (apple-touch-icon, etc., now larger and centered)
