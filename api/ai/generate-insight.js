  ...
  try {
    ...
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: 'You are a church insights assistant. Provide concise, actionable insights in 2-3 sentences. Be encouraging and practical.'
        },
        {
          role: 'user',
          content: prompt
      ...
      max_tokens: Math.min(max_tokens, 200), // Cap at 200 tokens for cost efficiency
