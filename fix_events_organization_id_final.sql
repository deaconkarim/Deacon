...
-- FINAL VERSION - properly handles all unique constraints
...
-- Handle groups more carefully - delete duplicates with null organization_id
...
-- Delete groups with null organization_id that have duplicates with the target org_id
